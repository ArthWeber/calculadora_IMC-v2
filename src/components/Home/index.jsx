...
function Home({ username, setUsername }) {
    ...
    return (
        <div className="styles.home">
            ...
            <p className="styles.home__textInfo">O Índice de Massa Corporal (IMC) é uma métrica usada para avaliar
            ...
            <h3 className="styles.subtitle"> Para garantir que sua saúde está em dia,
